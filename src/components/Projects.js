              ...
              >
                ...
                >
                  <span className="tooltiptext">
                    My first client project as a developer. Click to learn more.
                  </span>
                  <div className="project--img">
                    ...
                    />
                    <a
                      href="https://random-apis.netlify.app/"
                      target="_blank"
                    ></a>
                  </div>
                  ...
                  <div className="project--data">
                    ...
                    <div className="project--description">
                      Webpage for an art contest run by the UN environment
                      programme. The webpage was built with React and for the
                      voting phase I implemented Firebase Authentication and a
                      Firebase Database to register users and their votes.
                    </div>
